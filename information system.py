...
nameLabel = tk.Label(root, text="Enter your name", width=40, anchor='w',
                     font=("Sylfaen", 12)).grid(row=1, column=0, padx=(10,0),
                                                pady=(30, 0))
collegeLabel = tk.Label(root, text="Enter your ID", width=40, anchor='w',
...
addressLabel = tk.Label(root, text="Enter your Section", width=40, anchor='w',
...
def destroyRootWindow():
    ...
    tree.heading("two", text="ID")
    tree.heading("three", text="Section")
